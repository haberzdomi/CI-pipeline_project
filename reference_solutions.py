...
def circular_current(R_max, nR, nphi, nZ, R_0, I_c, nseg):
    ...
    make_field_file_from_coils('test_grid_file', 'test_coil_file', 'test_current_file', 'test_field_file', 1)
    ...
    for filename in ['test_grid_file', 'test_coil_file', 'test_current_file', 'test_field_file']:
        os.remove(filename)
